...
angular.module('linksgrabberApp')
  .directive('inlinemediaview', function () {
    ...
    return {
      	templateUrl : 'components/links/inlinemediaview.html',
      	scope: {
      		iivsrc : '=',
          iivshouldshowmedia : '=',
      	},
        ...
        controller : function ($scope) {
          ...
          var youtubeUrl = getYoutube(scope.iivsrc);
        	if( imgUrl !== ''){
            scope.isMedia = true;
            scope.urlView = 'components/links/inlineimageview.html';
           	scope._url = imgUrl;
            scope.type = 'image';
        	} else if(youtubeUrl !== ''){
            scope.isMedia = true;
            scope.urlView = 'components/links/inlineyoutubeview.html';
